...
## Addendum 2026-09-25: version pins (P00 T01)

Pins are the newest **stable** releases as of this date. Each package pins exact versions, and Dependabot proposes upgrades.

| Tool                     | Pinned                                                                   | Note                                                                                                                                         |
| ------------------------ | ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- |
| Node.js                  | 24 LTS (`.nvmrc`); engines `>=22.12`                                     | CI, Docker and Vercel all use 24.                                                                                                            |
| pnpm                     | 10.33.0                                                                  | via `packageManager`                                                                                                                         |
| Turborepo                | 2.11.4                                                                   |                                                                                                                                              |
| TypeScript               | **6.0.3**                                                                | 7.0.x (the native compiler) is the npm `latest`, but typescript-eslint 8.70 supports only `<6.1`. Revisit when typescript-eslint supports 7. |
| ESLint                   | 10.11.0 with typescript-eslint 8.70.1 and eslint-plugin-boundaries 7.2.0 |                                                                                                                                              |
| Prettier                 | 3.9.9                                                                    |                                                                                                                                              |
| Vitest                   | 5.0.2                                                                    |                                                                                                                                              |
| Prisma                   | **7.10.0**                                                               | npm `latest` is `8.0.0-rc.17`, a release candidate. Stable 7.x is pinned (see ADR-0004).                                                     |
